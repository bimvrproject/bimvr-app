<template>
  <div>
    ...
    <!-- <div style="margin-top: 44px; position: fixed; z-index: 0;">
      <div>
      <img style="width: 100%; height: 100%;z-index: 5;" src="../../assets/img/knock-home.png" @click="change()" />
      <div id="alert">
        <h5 style="margin-top: 10%;font-size: 18px">此处为第一处碰撞点</h5>
        <a-button 	style="margin-top: 2%; width: 45%; border-radius: 20px;height: 20px;" >
          返回	
        </a-button>
           &nbsp;
        <a-button type="primary"	style="margin-top: 2%; width: 45%; border-radius: 20px;height: 20px;">
            <h4>下一处</h4>
        </a-button>
      </div>
    </div>
    ...
    <div style="margin-top: 44px; position: fixed; z-index: 0;">
      <div>
        <img
          style="width: 100%; height: 100%;position: fixed; z-index: 30;"
          src="../../assets/img/knock-home.png"
        />
        <div id="alert">
          <h5 style="margin-top: 6%;font-size: 16px">请问要进行碰撞检查吗?</h5>
          <a-button
            style="margin-top: 1%; width: 45%; border-radius: 20px;height: 20px;"
            @click="openHome"
          >
            取消
          </a-button>
          ...
          <a-button
            type="primary"
            style="margin-top: 2%; width: 45%; border-radius: 20px;height: 20px;"
            @click="checkOff"
          >
            <h4>确定</h4>
          </a-button>
    ...
    >
      <a-row>
        ...
        <a-col :span="6">
          ...
          <div>
            <a style="color: #666666; font-size: 11px">材料</a>
          </div>
        </a-col>
        <a-col :span="6">
          <div v-on:click="openKnock()">
            <img
              src="../../assets/img/pengzhuang.png"
              style="width: 22px; height: 22px; margin-top: 5px;"
            />
          </div>
          <div>
            <a style="color: #2180ED; font-size: 11px">碰撞</a>
          </div>
        </a-col>
      </a-row>
    </div>
