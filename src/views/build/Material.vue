<template>
	<div>
		<!-- header开始 -->
		<div id="header_page_bg" style="position: fixed; top: 0; height: 44px; width: 100%;">
			<a-row>
				...
				<a-col :span="18"><h4 style="color: #FFFFFF; font-size: 18px; font-family: PingFangSC-Medium; margin-top: 9px;">材料</h4></a-col>
				<a-col :span="3"></a-col>
			</a-row>
		</div>
		<!-- header结束 -->
		...
		<div style="position: fixed; bottom: 0; width: 100%; height: 49px; background-color: #FAFAFA">
			<a-row>
				...
				<a-col :span="8">
					<div v-on:click="openPicture()"><img src="../../assets/img/picture_off.png" style="width: 22px; height: 22px; margin-top: 5px;" /></div>

					<div><a style="color: #666666; font-size: 11px">图纸</a></div>
				</a-col>
				<a-col :span="8">
					<div v-on:click="openMaterial()"><img src="../../assets/img/material_on.png" style="width: 22px; height: 22px; margin-top: 5px;" /></div>
					<div><a style="color: #2180ED; font-size: 11px">材料</a></div>
				</a-col>
			</a-row>
		</div>
		<!-- footer结束 -->
